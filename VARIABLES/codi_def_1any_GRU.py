# -*- coding: utf-8 -*-
"""
Created on Tue Aug 20 12:33:10 2024
...
# Crear les dades d'entrada per al model GRU setmanal
def create_gru_data(stock_data, labels, time_steps=4):
    x, y = [], []
...
x_weekly, y_weekly = create_gru_data(
...
# Crear el model GRU setmanal
model_gru = Sequential()
model_gru.add(GRU(50, return_sequences=True, input_shape=(time_steps_weekly, combined_data_weekly.shape[1])))
...
history_weekly = model_gru.fit(x_train_weekly, y_train_weekly, epochs=100, batch_size=32, validation_split=0.2, verbose=1)

# Predir amb les dades de prova
predictions_weekly = model_gru.predict(x_test_weekly)
