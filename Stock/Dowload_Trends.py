...
for keyword in keywords:
    ...
    pd_trends_data = pd_trends_data.resample('D').interpolate()
...
full_date_range = pd.date_range(start=start_date, end=end_date, freq='D')  # 'B' frequency is for business days
